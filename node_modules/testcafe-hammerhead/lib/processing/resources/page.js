...
var PageProcessor = function (_ResourceProcessorBas) {
    ...
    PageProcessor.prototype._createRestoreStoragesScript = function _createRestoreStoragesScript(storageKey, storages) {
        var scriptStr = (0, _dedent2.default)('\n            <script type="text/javascript" class="' + _className2.default.selfRemovingScript + '">\n                (function () {\n                    window.localStorage.setItem("' + storageKey + '", ' + (0, _stringify2.default)(storages.localStorage) + ');\n                    window.sessionStorage.setItem("' + storageKey + '", ' + (0, _stringify2.default)(storages.sessionStorage) + ');\n\n                    var script = document.currentScript || document.scripts[document.scripts.length - 1];\n                    script.parentNode.removeChild(script);\n                })();\n            </script>\n        ');
    ...
    PageProcessor.prototype.processResource = function processResource(html, ctx, charset, urlReplacer, processingOpts) {
        ...
        var iframeHtmlProcessor = function iframeHtmlProcessor(iframeHtml, callback) {
            ...
            var result = _this2.processResource(iframeHtml, ctx, charset, urlReplacer, processingOpts);
