...
var Proxy = function (_Router) {
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 18:
                            (0, _http3.respond500)(res, SESSION_IS_NOT_OPENED_ERR);
    ...
    Proxy.prototype.openSession = function openSession(url, session, externalProxyUrl) {
        session.proxy = this;
        this.openSessions[session.id] = session;

        if (externalProxyUrl) session.setExternalProxySettings(externalProxyUrl);
