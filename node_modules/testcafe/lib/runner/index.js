...
var Runner = function (_EventEmitter) {
    ...
    Runner.prototype.concurrency = function concurrency(_concurrency) {
        if (typeof _concurrency !== 'number' || isNaN(_concurrency) || _concurrency < 1) throw new _runtime.GeneralError(_message2.default.invalidConcurrencyFactor);
    ...
    Runner.prototype.reporter = function reporter(_reporter, outStream) {
        this.bootstrapper.reporter = _reporter;
    ...
    Runner.prototype.useProxy = function useProxy(externalProxyHost) {
    ...
    Runner.prototype.run = function run() {
        ...
        var runTaskPromise = this.bootstrapper.createRunnableConfiguration().then(function (_ref8) {
            ...
            return _this5._runTask(reporterPlugin, browserSet, tests, testedApp);
        });
