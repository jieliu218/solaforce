...
exports.default = {
    ...
    _getProviderModule: function _getProviderModule(providerName) {
        try {
            ...
            return _regenerator2.default.wrap(function _callee6$(_context6) {
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            provider = _this6._getProviderFromCache(providerName) || _this6._getProviderModule(providerName) || _this6._getBuiltinProvider(providerName);
