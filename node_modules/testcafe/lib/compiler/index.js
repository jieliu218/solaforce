...
var _esNext = require('./test-file/formats/es-next');

var _esNext2 = _interopRequireDefault(_esNext);

var _typescript = require('./test-file/formats/typescript');
...
var testFileCompilers = [new _testcafeLegacyApi.Compiler(_testcafeHammerhead2.default.processScript), new _esNext2.default(), new _typescript2.default(), new _raw2.default()];
