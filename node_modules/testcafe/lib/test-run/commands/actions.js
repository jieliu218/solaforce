...
exports.UseRoleCommand = exports.SetTestSpeedCommand = exports.GetNativeDialogHistoryCommand = exports.SetNativeDialogHandlerCommand = exports.SwitchToMainWindowCommand = exports.SwitchToIframeCommand = exports.ClearUploadCommand = exports.SetFilesToUploadCommand = exports.NavigateToCommand = exports.PressKeyCommand = exports.SelectTextAreaContentCommand = exports.SelectEditableContentCommand = exports.SelectTextCommand = exports.DragToElementCommand = exports.DragCommand = exports.TypeTextCommand = exports.HoverCommand = exports.DoubleClickCommand = exports.RightClickCommand = exports.ClickCommand = undefined;
...
function initSelector(name, val, skipVisibilityCheck) {
    ...
    try {
        var isRawAPIJsExpression = val !== null && (typeof val === 'undefined' ? 'undefined' : (0, _typeof3.default)(val)) === 'object' && val.type === RAW_API_JS_EXPRESSION_TYPE && typeof val.value === 'string';

        if (isRawAPIJsExpression) val = (0, _executeJsExpression.executeSelectorExpression)(val.value, skipVisibilityCheck);
...
var ClickCommand = exports.ClickCommand = function (_Assignable) {
    ...
    ClickCommand.prototype._getAssignableProperties = function _getAssignableProperties() {
        return [{ name: 'selector', init: initSelector, required: true }, { name: 'options', type: _argument.actionOptions, init: initClickOptions, required: true }];
    };
...
var HoverCommand = exports.HoverCommand = function (_Assignable4) {
    ...
    HoverCommand.prototype._getAssignableProperties = function _getAssignableProperties() {
        return [{ name: 'selector', init: initSelector, required: true }, { name: 'options', type: _argument.actionOptions, init: initMouseOptions, required: true }];
    };
...
var TypeTextCommand = exports.TypeTextCommand = function (_Assignable5) {
    ...
    TypeTextCommand.prototype._getAssignableProperties = function _getAssignableProperties() {
        return [{ name: 'selector', init: initSelector, required: true }, { name: 'text', type: _argument.nonEmptyStringArgument, required: true }, { name: 'options', type: _argument.actionOptions, init: initTypeOptions, required: true }];
    };
...
var DragCommand = exports.DragCommand = function (_Assignable6) {
    ...
    DragCommand.prototype._getAssignableProperties = function _getAssignableProperties() {
        return [{ name: 'selector', init: initSelector, required: true }, { name: 'dragOffsetX', type: _argument.integerArgument, required: true }, { name: 'dragOffsetY', type: _argument.integerArgument, required: true }, { name: 'options', type: _argument.actionOptions, init: initMouseOptions, required: true }];
    };
...
var DragToElementCommand = exports.DragToElementCommand = function (_Assignable7) {
    ...
    DragToElementCommand.prototype._getAssignableProperties = function _getAssignableProperties() {
        return [{ name: 'selector', init: initSelector, required: true }, { name: 'destinationSelector', init: initSelector, required: true }, { name: 'options', type: _argument.actionOptions, init: initMouseOptions, required: true }];
    };
...
var NavigateToCommand = exports.NavigateToCommand = function (_Assignable12) {
    ...
    NavigateToCommand.prototype._getAssignableProperties = function _getAssignableProperties() {
        return [{ name: 'url', type: _argument.urlArgument, required: true }];
    };
...
var SetFilesToUploadCommand = exports.SetFilesToUploadCommand = function (_Assignable13) {
    ...
    SetFilesToUploadCommand.prototype._getAssignableProperties = function _getAssignableProperties() {
        return [{ name: 'selector', init: function init(name, val) {
                return initSelector(name, val, true);
...
var SwitchToIframeCommand = exports.SwitchToIframeCommand = function (_Assignable15) {
    ...
    SwitchToIframeCommand.prototype._getAssignableProperties = function _getAssignableProperties() {
        return [{ name: 'selector', init: initSelector, required: true }];
    };
...
var UseRoleCommand = exports.UseRoleCommand = function (_Assignable18) {
    (0, _inherits3.default)(UseRoleCommand, _Assignable18);
    ...
    function UseRoleCommand(obj) {
        ...
        _this18.type = _type2.default.useRole;
        _this18.role = null;
