...
function addSnapshotPropertyShorthands(obj, getSelector, customDOMProperties, customMethods) {
    ...
    obj.hasClass = function (name) {
        ...
        return _resultPromise2.default.fromFn((0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee7() {
            var snapshot;
...
function addCounterProperties(obj, getSelector, SelectorBuilder) {
    ...
    Object.defineProperty(obj, 'exists', {
        get: function get() {
            ...
            return _resultPromise2.default.fromFn((0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee9() {
...
function addFilterMethods(obj, getSelector, SelectorBuilder) {
    ...
    obj.withAttribute = function (attrName, attrValue) {
        ...
        if (attrValue !== void 0) (0, _typeAssertions.assertType)([_typeAssertions.is.string, _typeAssertions.is.regExp], 'withAttribute', '"attrValue" argument', attrValue);
